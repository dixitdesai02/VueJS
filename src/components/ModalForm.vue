            ...
            <div class="p-4 sm:py-6 sm:px-12">
                <div class="mx-auto max-w-md bg-white border-0 sm:rounded-3xl">
                    ...
                    <div class="relative z-0 w-full mb-5">
                        ...
                        <label for="email" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">Detail</label>
                        <ErrorMessage class="text-red-600 text-sm" name="detail"/>
                    </div>
                    ...
                    <div class="relative z-0 w-full mb-5">
                        ...
                        <label for="price" class="absolute duration-300 top-3 left-5 -z-1 origin-0 text-gray-500">Car Price</label>
